...
const sidebarItems = [
    ...
    { icon: QrCode, label: "Generate QR", href: "/faculty/generate" },
        ...
        <div className="min-h-screen bg-background flex">
            ...
            >
                <div className="flex h-16 items-center border-b border-border px-6">
                    ...
                    <span className="font-bold text-lg text-foreground">SmartTrack</span>
                    <Button
                        variant="ghost"
                        size="icon"
                ...
                <div className="flex flex-col h-[calc(100vh-64px)] justify-between py-4">
                    ...
                    <div className="px-4">
                        <div className="mb-4 px-3 py-2 bg-secondary/50 rounded-lg border border-border">
                            <p className="text-sm font-medium truncate text-foreground">{user?.sub}</p>
