                ...
                <div className="flex flex-col h-[calc(100vh-64px)] justify-between py-6 px-4">
                    ...
                    <div>
                        <div className="mb-4 px-4 py-3 bg-muted/30 rounded-xl border border-border/50 flex items-center gap-3">
                            <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs">A</div>
                            <div className="overflow-hidden">
                                <p className="text-sm font-semibold truncate text-foreground">{user?.sub || "Admin"}</p>
